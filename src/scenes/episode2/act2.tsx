...
import { textBlock, contextYoY, quarterLabel, dataLoop, setBar, setLabel, setBarV2 } from "../../utils/designs";
import {
   date,
   header,
   capcomSales
...
export default makeScene2D(function* (view) {
    ...
    yield* loop(
        ...
        i => chain(
             ...
             all(
                setBarV2(barsMap[`${i}`], barValues.get(i)[0], -500, defaultY, 100, defaultHeight * thisFYQuickRatio.get(0).sales, "rgba(0, 255, 255, .80)", -500, -340, printValues.get(0).sales, 1),

                setBarV2(bars.get(i)[2], barValues.get(i)[1], -700, defaultY * lastFYQuickRatio.get(0).sales, 100, defaultHeight * lastFYQuickRatio.get(0).sales, "rgba(75, 0, 130, .80)", -700, -defaultHeight * lastFYQuickRatio.get(0).sales - 40, printLastFYValues.get(0).sales, 1),
